...
def state_cities():
    """
    This funtion renders a HTML template that list all the cities for a state
    in the /cities_by_states route is reached
    """
    return launch('8-cities_by_states.html',
